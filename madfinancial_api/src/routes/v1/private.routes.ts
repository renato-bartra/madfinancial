...
import { FilePrivateRoutes } from "../../api/v1/modules/files/infrestructure/routes/private.routes";
...
export class PrivateRoutes {
  ...
  private readonly fileRoutes: FilePrivateRoutes = new FilePrivateRoutes();
  ...
  private initRoutes = () => {
    ...
    this.router.use("/upload_files", this.fileRoutes.getRoutes());
  };
